...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-8 pt-0 pb-8">
      {/* Hero Section */}
      <section className="relative h-screen min-h-[100vh] flex items-center justify-center overflow-hidden bg-secondary/30 fixed inset-0 z-0">
        <div className="absolute inset-0 z-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center bg-no-repeat" />
      ...
      {/* Categories Grid */}
      <section id="services-grid" className="mx-auto px-6 md:px-12 pt-8">
        ...
        <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {categories.map((category, index) => (
            ...
            >
              <div 
                ...
                onClick={handleLoginClick}
              >
                <div className="relative aspect-[10/9] overflow-hidden rounded-2xl mb-6 shadow-md hover:shadow-xl transition-all duration-500">
                  <img 
                    src={category.image} 
                    alt={category.title}
      ...
      {/* Why Choose Section */}
      <section className="mx-auto px-6 md:px-12 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative max-w-md mx-auto order-2 lg:order-none">
      ...
      {/* Process of Work */}
      <section className="bg-primary text-white py-12 rounded-[3.5rem] mx-6 md:mx-12 relative overflow-hidden">
        ...
        <div className="px-6 md:px-12 relative z-10">
          ...
          <div className="mt-20 pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Button 
              variant="outline" 
              onClick={handleLoginClick}
              className="rounded-full border-white/20 hover:bg-white hover:text-primary transition-all px-8 py-6 text-lg group bg-transparent"
            >
              Start Your Journey
      ...
      <section className="bg-primary/5 py-20 rounded-3xl mx-6 md:mx-12">
        <div className="px-6 md:px-12">
          <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
